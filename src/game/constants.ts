...
export const DARK_COLOR_LEVELS: { threshold: number; ids: number[] }[] = [
  { threshold: 350, ids: [2, 14, 8, 20]  },  // оранжевый + коричневый, синий + тёмно-синий
  { threshold: 325, ids: [0, 12, 6, 18]  },  // жёлтый + тёмно-жёлтый, фиолетовый + тёмно-фиолет
  { threshold: 300, ids: [4, 16, 10, 22] },  // красный + бордовый, зелёный + тёмно-зелёный
  { threshold: 275, ids: [1, 13, 7, 19]  },  // жёлто-оранж + коричн-золот, сине-фиолет + тёмно-индиго
  { threshold: 250, ids: [3, 15, 9, 21]  },  // красно-оранж + тёмно-красн, сине-зелён + тёмно-бирюз
  { threshold: 225, ids: [5, 17, 11, 23] },  // красно-фиолет + тёмно-пурп, жёлто-зелён + оливковый
];
